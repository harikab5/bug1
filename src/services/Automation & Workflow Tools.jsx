      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-12 items-stretch">
        ...
        <div className="flex-1 flex items-center justify-center h-full">
          <div className="relative p-2 h-full flex items-center">
            <img src={agentImg} alt="Automation Tools" className="w-full h-full object-cover rounded-2xl shadow-xl relative z-10" style={{minHeight: '400px'}} />
        ...
        <div className="flex-1 flex flex-col justify-center h-full">
          <div className="text-justify h-full flex flex-col justify-center">
            <p className={`text-lg mb-8 ${theme === "dark" ? "text-white" : "text-black"}`}>Our automation tools deliver measurable business value, helping you scale operations, boost efficiency, and reduce costs.</p>
