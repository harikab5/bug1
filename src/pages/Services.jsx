            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="relative w-full h-[32rem] group overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#062731cc] to-transparent opacity-80 group-hover:opacity-90 transition duration-300"></div>
                    ...
                    <p className="text-[#fff] text-base text-justify leading-relaxed">
                      AI-driven automation, predictive maintenance, and quality control for modern factories. Our intelligent solutions optimize production processes and enhance operational efficiency while reducing costs and improving product quality through advanced machine learning algorithms.
                    </p>
                  </div>
              </div>
              {/* Industry 2 */}
              <div className="relative w-full h-[32rem] group overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-80 group-hover:opacity-90 transition duration-300"></div>
                    ...
                    <p className="text-[#fff] text-base text-justify leading-relaxed">
                      AI for diagnostics, patient care, and operational efficiency in healthcare systems. Our advanced algorithms assist in medical imaging analysis and treatment optimization, helping healthcare providers deliver better patient outcomes through predictive analytics and personalized care recommendations.
                    </p>
                  </div>
              </div>
              {/* Industry 3 */}
              <div className="relative w-full h-[32rem] group overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#29828ecc] to-transparent opacity-80 group-hover:opacity-90 transition duration-300"></div>
                    ...
                    <p className="text-[#fff] text-base text-justify leading-relaxed">
                      Smart routing, demand forecasting, and supply chain optimization with AI. Our intelligent systems streamline transportation networks and optimize inventory management, providing real-time tracking and predictive analytics to reduce delivery times and operational costs.
                    </p>
                  </div>
              </div>
              ...
              <div className="relative w-full h-[32rem] group overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#111211cc] to-transparent opacity-80 group-hover:opacity-90 transition duration-300"></div>
                    ...
                    <p className="text-[#fff] text-base text-justify leading-relaxed">
                      Personalized recommendations, inventory management, and customer insights powered by AI. Our solutions enhance customer experience through intelligent product suggestions and dynamic pricing strategies, driving increased sales and customer loyalty through data-driven personalization.
                    </p>
                  </div>
              </div>
            </div>
